		...
		<div class="row clearfix">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="card">
					<?php if (isset($alterar)) { ?>
						...
						<div class="header">
							<h2>
								EDITAR - <span style="font-size:12px">TIPO MOTIVO (<b><?= $alterar['nome'] ?></b>)</span>
							</h2>
						</div>
						<div class="body">
							<form id="form1" class="form-horizontal" action="<?= base_url() ?>tipoMotivo/alterar" method="POST">
								<div class="form-group">
									...
									<div class="col-sm-4">
										<input type="hidden" name="id_tipomotivo" value="<?= $alterar['id'] ?>">
					...
					<?php } else { ?>
						...
						<div class="header">
							<h2>
								CADASTRAR - <span style="font-size:12px">TIPO MOTIVO</span>
							</h2>
						</div>
						<div class="body">
							<form id="form1" class="form-horizontal" action="<?= base_url() ?>tipoMotivo/cadastrar" method="POST">
								<div class="form-group">
									<label class="col-sm-1 control-label" for="nome">Nome:</label>
									<div class="col-sm-6">
										<div class="form-line">
											<input type="text" class="form-control" name="nome" id="nome" placeholder="Digite o tipo de motivo">
										</div>
									</div>
									<div class="col-sm-4">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="card">
					<div class="header">
						<h2>
							CONSULTAR - <span style="font-size:12px">TIPO MOTIVO</span>
						</h2>
					</div>
					<div class="body">
							...
							<tbody>
								...
								foreach ($tipos as $row) { ?>
									...
									<tr>
										<td><?= $row->nome ?></td>
										<td>
											<a href="<?= base_url() ?>tipoMotivo/editar/<?= $row->id ?>" class="btn btn-primary waves-effect">
											...
											<button type="button" class="btn btn-danger waves-effect" data-trigger="focus" data-container="body" data-toggle="popover" data-placement="top" data-original-title="Confirmar exclusão?" data-content="
                                						<form action='<?= base_url() ?>tipoMotivo/deletar' method='POST'>
                                							<button type='submit' name='id_tipomotivo' value='<?= $row->id ?>' class='btn btn-success'>
