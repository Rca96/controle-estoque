...
<head>
    ...
    <title>Login | Painel - Controle de Estoque - PMA</title>
    <!-- Favicon-->
...
<body class="login-page" style="background:url('images/maps3.jpg');background-size:100%">
    <div id='map-canvas'></div>
    <div class="login-box">
        <div class="logo" style="position: relative;">
            <a href="javascript:void(0);">Controle de Estoque - <b>PAINEL</b></a>
            <small style="padding-bottom:5px">Departamento de Tecnologia da Informação</small>
            <small>Prefeitura de Araras</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="login" method="POST" action="<?=base_url()?>login/login">
